(function() {
  ...
  charlotte.createBrowser = function(options){
            ...
            renderWait(function(err) {
              ...
              renderTemplate(bundle.version, layoutPath, bundle.template, req,
                ...
                function(err, html) {
                  ...
                  var onDestroy = settings.onDestroy || browser.onDestroy;
    ...
    function createTab(options) {
      ...
      tab = {
        ...
        load: function(settings, triggerReadyCallback, isReload) {
          ...
          var self = this,
              ...
              loadRequestId,
              isPost = false,
              onDestroy = settings.onDestroy || self.onDestroy || browser.onDestroy;
        ...
        back: function(options, callback) {
          ...
          $(contentCtr).off();
          var onDestroy = (onBack && onBack.onDestroy) || this.onDestroy || this.browser.onDestroy
          if (onDestroy) onDestroy(contentCtr);
          async.waterfall([
            function(next) {
              if (transition) {
        ...
        reload: function(callback, isRedirectFromPost, newUrl) {
          ...
          $(contentCtr).off()
          var onDestroy = settings.onDestroy || this.onDestroy || this.browser.onDestroy;
          if (onDestroy) onDestroy(contentCtr);
      ...
      tab.isATab = true;
      if (!tab.transitions) tab.transitions = transitions;
